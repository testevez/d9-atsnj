...
namespace Drupal\atsnj\Plugin\Field\FieldFormatter;
 ...
 *
 * @FieldFormatter(
 *   id = "atsnj_file_formatter",
 *   label = @Translation("ATSNJ Download"),
 *   field_types = {
 *     "file",
 *     "image"
 *   }
 * )
 */
class AtsnjFileFormatter extends FileFormatterBase {
