 ...
 * @Action(
 *   id = "make_certificate",
 *   label = @Translation("Create all the EBP certificates for an EBP Attendee"),
 *   type = "node",
 * )
 */
class MakeCertificate extends ViewsBulkOperationsActionBase {
  ...
  public function execute(NodeInterface $node = NULL) {
    ...
    _atsnj_bulk_actions_make_certs($node);
